...
export default function FerrariSpotlightVideo({ member }) {
    ...
    // Ferrari entrance animations - starts after extended blackout at 0.55
    const ferrariProgress = useTransform(smoothProgress, [0.55, 1], [0, 1]);
    const ferrariOpacity = useTransform(smoothProgress, [0.55, 0.57], [0, 1]); // Fast fade in
    const ferrariScale = useTransform(smoothProgress, [0.55, 0.57], [0.95, 1.0]);
            ...
            <div className="sticky top-0 h-screen w-full overflow-hidden" style={{ zIndex: 1 }}>
                ...
                <div
                    ...
                    style={{
                        ...
                        opacity: currentProgress >= 0.25 && currentProgress < 0.55 ? 1 : 0,
                        pointerEvents: 'none'
                    }}
                />
